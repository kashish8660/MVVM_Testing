...
class MainViewModel(private val repository: ProductRepository) : ViewModel() {
    ...
    fun getProducts(){
        viewModelScope.launch {//launching ViewModel coroutine
            val result = repository.getProducts() //getting result through repository and setting it through postValue() below
