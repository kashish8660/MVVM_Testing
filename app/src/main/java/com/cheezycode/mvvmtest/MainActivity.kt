...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val repository = (application as StoreApplication).productRepository //"application" is an instance of Application class, and
        //casting it as StoreApplication(it extends Application class) so thet the productRepository property can be accessed
